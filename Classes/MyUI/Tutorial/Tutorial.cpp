...
CTutorial* CTutorial::Instance()
{
    if(m_Instance != nullptr) return m_Instance;
    
    m_Instance = new(std::nothrow) CTutorial();
...
void CTutorial::update(float delta)
{
...
void CTutorial::addTutorial(std::string key, CTutorialObject* newTutorial)
{
...
void CTutorial::ChangeTutorial(std::string key)
{
    if(key == "") return;
...
void CTutorial::ChangeStep(int index)
{
...
CTutorial::TUTORIAL* CTutorial::addNewTutorialByKey(std::string key)
{
...
CTutorial::TUTORIAL* CTutorial::getTutorialByKey(std::string key)
{
...
CTutorialObject* CTutorial::getStepFromTutorial(std::string key, int index)
{
...
void CTutorial::stepBegin(std::string key, int index)
{
...
void CTutorial::stepEnd(std::string key, int index)
{
    auto step = this->getStepFromTutorial(key, index);
    step->End();
...
CTutorialObject* CTutorialObject::build(std::string key)
{
    ...
    CTutorial::Instance()->addTutorial(m_TutorialKey, this);
    return this;
}
