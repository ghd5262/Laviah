...
bool CSpaceShip::init()
{
    ...
    setPositionX((cos(CC_DEGREES_TO_RADIANS(90)) *  /*getBulletInfo()._fDistance*/ m_fDistance) + m_Planet->getPosition().x);
    setPositionY((sin(CC_DEGREES_TO_RADIANS(90)) *  /*getBulletInfo()._fDistance*/ m_fDistance) + m_Planet->getPosition().y);
